...
<link rel="stylesheet" href="{{asset('css/admin/safe_transfers/all_transfers.css')}}">
...
<script src="{{asset('js/admin/safe_transfers/all_transfers.js')}}" type="text/javascript"></script>
@endsection