                ...
                <th>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item" onclick="openPDF('{{asset("files/".request()->session()->get('userLogout')."/img/logo.png")}}', '{{$lang->title5}}', '{{$lang->label29}}', '{{$lang->label30}}', '{{$lang->label31}}', '{{$lang->label32}}', '{{$lang->label33}}', '{{$lang->label34}}', '{{$lang->label35}}', '{{$lang->label36}}', '{{$lang->label37}}', '{{$lang->label38}}', '{{$lang->label39}}', '{{$lang->label40}}', '{{$lang->label41}}', '{{$lang->label42}}', '{{$lang->label43}}', '{{$loop->index+1}}', '{{$receipt->getPaymentDate()}}', '{{$receipt->getMyPatient()->getName()}}', '{{$receipt->getMyPatient()->getPatentCode()}}', {{json_encode($receipt->getTestPdf())}}, '{{$lang->table26}}', '{{$receipt->getSubtotal()}}', '{{$receipt->getTotalDiscount()}}', '{{$receipt->getTotal()}}', '{{$receipt->getPaymentDate()}}', '{{$receipt->getAmountPaid()}}', '{{$receipt->getPaymentMethod()}}', '{{$receipt->getDue()}}')">{{$lang->selectBox7}}</a></li>
                        </ul>
                    </div>
