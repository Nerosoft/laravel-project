...
<link rel="stylesheet" href="{{asset('css/admin/test_cultures/the_cultures.css')}}">
...
@include('layout.all_tests.create_edit_tests', ['action'=>route('createCultures')])
    ...
    <thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                @include('layout.all_tests.create_edit_tests', ['action'=>route('editCultures')])
                </th>
            </tr>
            @endforeach
        </tbody>
...
<script src="{{asset('js/admin/test_cultures/the_cultures.js')}}" type="text/javascript"></script>
@endsection