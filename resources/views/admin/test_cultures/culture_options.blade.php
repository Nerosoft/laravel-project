...
<link rel="stylesheet" href="{{asset('css/admin/test_cultures/culture_options.css')}}">
...
<div class="space-page container">
    <h1>culture options</h1>
</div>
<script src="{{asset('js/admin/test_cultures/culture_options.js')}}" type="text/javascript"></script>
@endsection