...
<link rel="stylesheet" href="{{asset('css/admin/reporting/all_doctor_report.css')}}">
...
<div class="space-page container">
    <h1>all_doctor_report</h1>
</div>
<script src="{{asset('js/admin/reporting/all_doctor_report.js')}}" type="text/javascript"></script>
@endsection