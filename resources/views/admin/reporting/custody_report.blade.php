...
<link rel="stylesheet" href="{{asset('css/admin/reporting/custody_report.css')}}">
...
<div class="space-page container">
    <h1>custody_report</h1>
</div>
<script src="{{asset('js/admin/reporting/custody_report.js')}}" type="text/javascript"></script>
@endsection