...
<link rel="stylesheet" href="{{asset('css/admin/reporting/testes_branch_report.css')}}">
...
<div class="space-page container">
    <h1>testes_branch_report</h1>
</div>
<script src="{{asset('js/admin/reporting/testes_branch_report.js')}}" type="text/javascript"></script>
@endsection