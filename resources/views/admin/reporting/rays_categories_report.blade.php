...
<link rel="stylesheet" href="{{asset('css/admin/reporting/rays_categories_report.css')}}">
...
<div class="space-page container">
    <h1>rays_categories_report</h1>
</div>
<script src="{{asset('js/admin/reporting/rays_categories_report.js')}}" type="text/javascript"></script>
@endsection