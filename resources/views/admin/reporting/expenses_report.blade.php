...
<link rel="stylesheet" href="{{asset('css/admin/reporting/expenses_report.css')}}">
...
<script src="{{asset('js/admin/reporting/expenses_report.js')}}" type="text/javascript"></script>
@endsection