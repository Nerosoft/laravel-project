...
<link rel="stylesheet" href="{{asset('css/admin/reporting/contract_report.css')}}">
...
<div class="space-page container">
    <h1>contract_report</h1>
</div>
<script src="{{asset('js/admin/reporting/contract_report.js')}}" type="text/javascript"></script>
@endsection