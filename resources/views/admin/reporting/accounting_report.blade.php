...
<link rel="stylesheet" href="{{asset('css/admin/reporting/accounting_report.css')}}">
...
<div class="space-page container">
    <h1>accounting_report</h1>
</div>
<script src="{{asset('js/admin/reporting/accounting_report.js')}}" type="text/javascript"></script>
@endsection