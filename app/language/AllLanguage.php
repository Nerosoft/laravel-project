...
class AllLanguage extends TableSetting
{
    ...
    {   
        ...
        parent::__construct($ob[$ob['Setting']['Language']]['Error'],
            ...
            isset($ob[$ob['Setting']['Language']]['Title'][$title])?$ob[$ob['Setting']['Language']]['Title'][$title]:$ob[$ob['Setting']['Language']]['CutomLang'][$title],
