...
class PatientController extends PatientInfo implements LangObject
{
    public function initView(){
        ...
        $this->tableData = $this->myPat?Patent::fromArray(array_reverse($this->myPat), $this->myContract, $this->ob[$this->language]['SelectGenderBox'], $this->ob[$this->language]['SelectNationalityBox'], $this->dis):array();
        $this->actionDelete = route('deleteItem', 'Patent');
    ...
    public function __construct(){
        ...
        parent::__construct('Patent', $this->ob);
    }
