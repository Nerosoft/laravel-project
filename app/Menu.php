...
class Menu
{
    ...
    public function getPatentDashboard(){
        return $this->PatentDashboard;
    }
    public function getPatentReports(){
        return $this->PatentReports;
    }
    public function getTestsLibrary(){
        return $this->TestsLibrary;
    }
    public function getPatentHomeVisit(){
        return $this->PatentHomeVisit;
    }
    public function getPatentOurBranches(){
        return $this->PatentOurBranches;
    }
    //--------------------------------------
    ...
    public function getDoctorMedicalReports(){
        return $this->DoctorMedicalReports;
    }
    public function getTheDoctorReport(){
        return $this->TheDoctorReport;
    }
    public function getTheClearCache(){
        return $this->TheClearCache;
    }
    public function getTechnicalSupports(){
    ...
    public function getTestCultures(){
    ...
    public function getSafeTransfers(){
        return $this->SafeTransfers;
    }
    ...
    public function getBranchesCustody(){
        return $this->BranchesCustody;
    }
